...
// Soft Mint Light Theme Palette
// Background: #FAFAF9 (stone-50) - warm off-white
// Cards: #ECFDF5 (emerald-50) - soft mint
// Inner cards: #F0FDF4 (green-50)
// Borders: #D1FAE5 (emerald-200)

export const themeClasses = {
  // Background colors
  bg: {
    primary: (theme: Theme) => theme === 'light' ? 'bg-stone-50' : 'bg-neutral-950',
    secondary: (theme: Theme) => theme === 'light' ? 'bg-emerald-50' : 'bg-neutral-900/40',
    tertiary: (theme: Theme) => theme === 'light' ? 'bg-emerald-100' : 'bg-neutral-800',
    card: (theme: Theme) => theme === 'light' ? 'bg-emerald-50' : 'bg-neutral-900/40',
    hover: (theme: Theme) => theme === 'light' ? 'hover:bg-emerald-100' : 'hover:bg-neutral-800',
  },
  ...
  // Border colors
  border: {
    primary: (theme: Theme) => theme === 'light' ? 'border-emerald-200' : 'border-neutral-800',
    secondary: (theme: Theme) => theme === 'light' ? 'border-emerald-300' : 'border-neutral-700',
  },

  // Input/Form colors
  input: {
    bg: (theme: Theme) => theme === 'light' ? 'bg-white' : 'bg-neutral-950',
    border: (theme: Theme) => theme === 'light' ? 'border-emerald-200' : 'border-neutral-800',

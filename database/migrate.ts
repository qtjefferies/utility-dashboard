...
switch (command) {
  ...
  default:
    console.log('Usage:');
    console.log('  tsx database/migrate.ts          # Run migrations');
    console.log('  tsx database/migrate.ts status   # Show migration status');
    console.log('  tsx database/migrate.ts rollback # Remove last migration record');
    process.exit(1);
}
